...
.field private deferredComponentManager:Lz/a;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Lx/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Ly/d;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Ly/d;->d(ILjava/nio/ByteBuffer;)V
...
.method private static synthetic lambda$decodeImage$0(JLandroid/graphics/ImageDecoder;Landroid/graphics/ImageDecoder$ImageInfo;Landroid/graphics/ImageDecoder$Source;)V
    ...
    invoke-static {p4}, Lio/flutter/embedding/android/o;->a(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lh0/g;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lh0/g;

    invoke-virtual {p1, v0}, Lh0/g;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Lx/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/l$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Lg0/m;->b(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/l$g;->e:I
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Lf0/t;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Ly/d;->b(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public onFirstFrame()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/engine/renderer/j;->d()V
...
.method onRenderingStopped()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/engine/renderer/j;->g()V
...
.method public setDeferredComponentManager(Lz/a;)V
    .locals 0
    ...
    invoke-interface {p1, p0}, Lz/a;->a(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Lh0/g;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lh0/g;

    return-void
.end method

.method public setPlatformMessageHandler(Ly/d;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Ly/d;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Lk0/d;->a(ZLjava/lang/Object;)V
