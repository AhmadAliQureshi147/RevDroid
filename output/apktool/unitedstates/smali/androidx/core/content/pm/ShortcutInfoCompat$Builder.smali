...
.method public constructor <init>(Landroid/content/Context;Landroid/content/pm/ShortcutInfo;)V
    ...
    .line 40
    invoke-static {p2}, Lcb;->a(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;
    ...
    .line 41
    invoke-static {p2}, Ldb;->a(Landroid/content/pm/ShortcutInfo;)Ljava/lang/String;
    ...
    .line 42
    invoke-static {p2}, Lfb;->a(Landroid/content/pm/ShortcutInfo;)[Landroid/content/Intent;
    ...
    .line 44
    invoke-static {p2}, Lgb;->a(Landroid/content/pm/ShortcutInfo;)Landroid/content/ComponentName;
    ...
    .line 45
    invoke-static {p2}, Lhb;->a(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;
    ...
    .line 46
    invoke-static {p2}, Lib;->a(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;
    ...
    .line 47
    invoke-static {p2}, Ljb;->a(Landroid/content/pm/ShortcutInfo;)Ljava/lang/CharSequence;
    ...
    .line 49
    invoke-static {p2}, Lkb;->a(Landroid/content/pm/ShortcutInfo;)I
    ...
    .line 50
    :cond_0
    invoke-static {p2}, Ltb;->a(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 52
    :goto_1
    invoke-static {p2}, Llb;->a(Landroid/content/pm/ShortcutInfo;)Ljava/util/Set;
    ...
    .line 53
    invoke-static {p2}, LQa;->a(Landroid/content/pm/ShortcutInfo;)Landroid/os/PersistableBundle;
    ...
    .line 54
    invoke-static {p2}, Lmb;->a(Landroid/content/pm/ShortcutInfo;)Landroid/os/UserHandle;
    ...
    .line 55
    invoke-static {p2}, Lnb;->a(Landroid/content/pm/ShortcutInfo;)J
    ...
    .line 56
    invoke-static {p2}, Lob;->a(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 57
    :cond_2
    invoke-static {p2}, Lpb;->a(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 58
    invoke-static {p2}, Lqb;->a(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 59
    invoke-static {p2}, Lrb;->a(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 60
    invoke-static {p2}, Lsb;->a(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 62
    invoke-static {p2}, Lub;->a(Landroid/content/pm/ShortcutInfo;)Z
    ...
    .line 64
    invoke-static {p2}, Leb;->a(Landroid/content/pm/ShortcutInfo;)I
